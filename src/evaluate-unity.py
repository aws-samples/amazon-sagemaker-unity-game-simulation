...
if __name__ == "__main__":
    ...
    # Save summary logs in output path
    env_name = args.env.split('.')[0]
    shutil.copytree("/opt/ml/input/data/train/{}_Data/Logs".format(env_name), "/opt/ml/output/intermediate/Logs")
    # print('************** LOG OUTPUT **************')
    # files = glob("/opt/ml/output/intermediate/Logs/*.csv", recursive=True)
    # for file in files:
    #    print(file)
